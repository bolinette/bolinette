...
from bolinette.core.expressions._exceptions import AttributeChainError, MaxDepthExpressionError
from bolinette.core.expressions._nodes import AttributeNode, ElementNode, ExpressionNode, RootNode
...
class ExpressionTree:
    ...
    @staticmethod
    def new(origin: Any | None = None) -> RootNode:
    ...
    def set_value(expr: ExpressionNode, obj: object, value: Any) -> None:
        return object.__getattribute__(expr, "__expr_set_value__")(obj, value)
