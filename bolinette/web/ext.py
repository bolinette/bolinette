...
from bolinette.web import (
    WebContext, Controller, ControllerMetadata, ControllerRoute,
...
class WebExtension(BolinetteExtension[WebContext]):
    ...
    def controller(self, controller_name: str, path: str | None = None, *,
...
class _RouteDecorator:
    def __call__(self, path: str, *, method: HttpMethod, expects: Expects = None,
              returns: Returns = None, middlewares: str | list[str] | None = None):
        ...
        def decorator(route_function: Callable):
            if (not isinstance(route_function, InstantiableAttribute)
            ...
            return InstantiableAttribute(ControllerRoute, dict(
    ...
    def get(self, path: str, *, returns: Returns = None,
            middlewares: str | list[str] | None = None):
        return self(path, method=HttpMethod.GET, expects=None, returns=returns, middlewares=middlewares)


    def post(self, path: str, *, expects: Expects = None, returns: Returns = None,
            middlewares: str | list[str] | None = None):
        return self(path, method=HttpMethod.POST, expects=expects, returns=returns, middlewares=middlewares)


    def put(self, path: str, *, expects: Expects = None, returns: Returns = None,
            middlewares: str | list[str] | None = None):
        return self(path, method=HttpMethod.PUT, expects=expects, returns=returns, middlewares=middlewares)


    def patch(self, path: str, *, expects: Expects = None, returns: Returns = None,
            middlewares: str | list[str] | None = None):
        return self(path, method=HttpMethod.PATCH, expects=expects, returns=returns, middlewares=middlewares)


    def delete(self, path: str, *, returns: Returns = None,
            middlewares: str | list[str] | None = None):
        return self(path, method=HttpMethod.DELETE, expects=None, returns=returns, middlewares=middlewares)
