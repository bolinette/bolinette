...
class Column(Field):
    def __init__(self, column: 'db.types.Column', *, name=None, default=None, required=False,
...
class Reference(Definition):
    def __init__(self, relationship: 'db.types.Relationship', model_key='default', *, name=None, default=None,
                 required=False, function=None, formatting=None):
