...
class BookModel(Model[Book]):
    ...
    author_id = types.defs.Column(
        types.db.Integer, reference=types.defs.Reference("person", "id"), nullable=False
    )
    author = types.defs.Relationship(
        "person",
        foreign_key="author_id",
        backref=types.defs.Backref("books"),
        lazy=False,
    )
